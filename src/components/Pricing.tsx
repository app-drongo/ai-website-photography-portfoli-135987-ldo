  ...
  const plans = [
    ...
    },
    {
      ...
      features: [
        ...
        "Client booking templates",
        "Pricing strategy workshop",
        "Jake Wilson's personal mentorship",
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="text-lg text-muted-foreground leading-relaxed mb-8">
            Choose your path from beginner to professional photographer. 
            Lifetime access, no subscriptions, learn at your own pace.
          </p>
        ...
        <div className="text-center mt-16 max-w-2xl mx-auto">
          ...
          <p className="text-muted-foreground mb-6">
            Jake Wilson personally answers questions about Photography Masterclass. 
            Get clarity on which option is right for your photography goals.
          </p>
